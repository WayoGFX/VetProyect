...
class CitaProvider
  ...
  loadCitasByUsuario(
    ...
    try {
      ...
      _errorMessage = e.toString();
      print(
        'Error al cargar citas del usuario: $e',
      );
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  loadCitasByVeterinario(
    ...
    try {
      ...
      _errorMessage = e.toString();
      print(
        'Error al cargar citas del veterinario: $e',
      );
    } finally {
      _isLoading = false;
      notifyListeners();
    ...
    try {
      ...
      _citas = todasCitas.where(
        (
          ...
          return fechaCita.isAfter(
                hoyInicio,
              ) ||
              fechaCita.isAtSameMomentAs(
                hoyInicio,
              );
        },
      ).toList();
  ...
  loadCitasByMonth(
    ...
    try {
      ...
      _errorMessage = e.toString();
      print(
        'Error al cargar citas del mes: $e',
      );
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  /// Cargar citas de una mascota específica
  Future<
    void
  >
  loadCitasByMascota(
    ...
    try {
      ...
      _errorMessage = e.toString();
      print(
        'Error al cargar citas de la mascota: $e',
      );
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  getCitasByDate(
    ...
    return _citas.where(
      (
        ...
        return citaDate.isAtSameMomentAs(
          targetDate,
        );
      },
    ).toList();
  ...
  loadCitaById(
    ...
    try {
      _citaSeleccionada = await _apiService.getCitaById(
        id,
      );
    } catch (
      e
