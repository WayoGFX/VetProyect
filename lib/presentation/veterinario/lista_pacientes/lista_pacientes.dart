...
class ListaPacientes extends StatelessWidget {
  ...
  final List<Map<String, String>> pacientes = const [
    {
      ...
      'nombre': 'max',
      'image':
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBaKPuzBW06LGsePkAIow9d6jqVGF05fJtdQPg5AQ7WwQddDO9oXc3m2ZubuFbTNboAfEZyTmbLinJ5shiY8QV49_L4VP_eDtuFlX9ybixL0AW4G43WloDCOQmkBz4qp8qHCosHwpPxk-gzq0w_1T8SQJBsibLj8iyQi1j_k5iLzqJQC3qXVAvRHEyYeR_0qLa0dXTWDnTlgB3AKA0t0lur54nNrX5_Ni4-BDL1O-XCVoQ4uUwzvF-qiT3yTuCAGrompkVgIYYLb3E'
    },
    {
      'name': 'Bella',
      'nombre': 'Bella',
      'image':
          'https://lh3.googleusercontent.com/aida-public/AB6AXuA8kpFucsItJZdHfv7zgrVsARMX0oKJa8420CMlpmzbjjzQxOOH_27l3LgbFEeHTSSXhbxnwSMCLiE0Bq2OFclV-5j6cNr-k7OM6TzSHqXHXNaye2BNCK_HijC4Hh_aPYlDgT__tu0SkBdc_7E91eVY7xnFC6hnw67_r2awR-zkLnv5_TcEuFMgc0tJxvINOyWQbyez1mKJdLp7lGr4C7L1xFLGVaihd9GgRcxIFdpo9eCFUAlkk0FF_IiXXZLcGeaiynid1cBxJKM'
    },
    {
      'name': 'Rocky',
      'nombre': 'Rocky',
      'image':
          'https://lh3.googleusercontent.com/aida-public/AB6AXuCpMJZ7Ny8d3cb4QjbNr9i_QI84vmsU2HXiWB9hr-9lrKtO2Hxuvmq0ODuRx7VTscQ-v6l_4rxQbZ9apBSiypKKZG_ySmTl8REZ7CfLtrwmXauOVBp7I5rfySgf-TIkHJCRqEchOtIOJ0YXr3zU0ZT8ogIs4tiK48NEw0r1G2CulrKBmKMKAyoCJZ7FMuuBjFbhL4ibW-YrpEmEHapgZStcqqbKXIBheDz8TYvy9OrtfrubKQuOrwDAgxhhraVh6m_YPUKO-FN-3QY'
    },
    {
      'name': 'Luna',
      'nombre': 'Luna',
      'image':
          'https://lh3.googleusercontent.com/aida-public/AB6AXuD3SQTQKBLpb_hbb8aClUjOYL31-8PfnsGfh01oEW3IJWS0ZZi0ArDSICM7ENO1-oFXrP82eqohaq5yMQm1sxY5kSYXeQA6QzsVJvkgWV9byKhcO1-h65pMPfMU-gVGqWHjU43FQHqXWoLxfMpi3SS8Z0D-3V7f0MQVg0isv-6b0oDdkdFrSTe63TAfITerXSJTGZHiktl3AHQYu_wdct87oAawh4_l6x1FZBgA8ErEkr3cfyHMiTwO38ZOaQ0VG-3jcKBQABJAiT0'
    },
  ];
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {}, // Acción de regreso pendiente
        ),
        title: Text(
          'Pacientes',
      ...
      body: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
               _buildFilterChip(context, 'Especie'),
                const SizedBox(width: 8),
                _buildFilterChip(context, 'Edad'),
                const SizedBox(width: 8),
                _buildFilterChip(context, 'Estado de salud'),
              ],
            ),
          ),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    // Lógica para ir al detalle del paciente
                  },
                );
              },
            ),
  ...
  Widget _buildFilterChip(BuildContext context, String label) {
    return FilterChip(
      ...
      onSelected: (value) {}, // Maneja la selección del filtro
