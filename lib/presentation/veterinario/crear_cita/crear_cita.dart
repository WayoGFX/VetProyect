...
class _CrearCitaWidgetState
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final citaProvider = context
          .read<
            CitaProvider
          >();
      final success = await citaProvider.createCita(
        nuevaCita,
      );
  ...
  Widget build(
    ...
    final mascotaProvider = context
        .watch<
          MascotaProvider
        >();
    final veterinarioProvider = context
        .watch<
          VeterinarioProvider
        >();
                      ...
                      child: DropdownButtonHideUnderline(
                        child:
                            ...
                            >(
                              ...
                              items: mascotaProvider.mascotas.map(
                                (
                                  mascota,
                                ) {
                      ...
                      child: DropdownButtonHideUnderline(
                        child:
                            ...
                            >(
                              ...
                              items: veterinarioProvider.veterinarios.map(
                                (
                                  vet,
                                ) {
                                  return DropdownMenuItem(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (vet.especialidad.isNotEmpty)
                                          Text(
                                            vet.especialidad,
                                            style: TextStyle(
                                              fontSize: 12,
